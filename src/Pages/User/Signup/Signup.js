  ...
  return (
    <div className='container-fluid p-0'>
        ...
        <div className='container-fluid signup-bg'>
            <div className='row'>
                <div className='col text-center m-5 mb-3 text-primary'>
                    <h1>Sign Up</h1>
                </div>
            </div>
            <div className='row '>
          <div className='col d-flex justify-content-center form-floating m-auto '>
            ...
            <div className='row'>
                <div className='col d-flex justify-content-center form-floating m-auto'>
                    <input type="date" className="form-control m-5" id="floatingDob" placeholder="YYYY-MM-DD" />
                    <label htmlFor='floatingDob' className='mx-5 w-25'>Date of Birth</label>
                </div>
            </div>    
            <div className='row'>
                <div className='col d-flex justify-content-center form-floating m-auto'>
                    <textarea type="text" class="form-control m-5" id="floatingAbout" placeholder="Write something about yourself..." rows="3"></textarea>
                    <label htmlFor='floatingAbout' className='mx-5 w-25'>About</label>
                </div>
            </div> 
            <div className='row'>
                <div className='col text-center text-primary fs-5'>
                    <p>
                        Already have an account , <Link to={''} className='text-decoration-none link-primary'>Login</Link>
                    </p>
                </div>
            </div>
            <div className='row'>
                <div className='col text-center m-3'>
                    <button type="button" className="btn btn-primary w-25 m-1">Sign up <svg className='ms-1' xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
